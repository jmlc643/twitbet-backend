...
func main() {
	...
	if err := database.AutoMigrate(db, &identityModel.UserModel{}, &leagueModel.LeagueModel{}, &leagueModel.ParticipantModel{}, &leagueModel.TransactionModel{}, &leagueModel.MatchModel{}, &leagueModel.MarketModel{}, &leagueModel.MarketOptionModel{}, &leagueModel.BetModel{}, &leagueModel.ParticipantBonusModel{}); err != nil {
