...
type CombinedBetRepository interface {
	...
	GetByParticipantID(ctx context.Context, participantID uuid.UUID, status *string, startDate, endDate *time.Time, limit, offset int) ([]entity.CombinedBet, int64, error)
